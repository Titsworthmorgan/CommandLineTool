...
- `.clang-format`: Configuration file for code formatting, this was honestly just breaking my brain a bit reading the syntax so I googled how to make the syntax a little more comfortable for me personally in a temporary format that does not affect compilation or runtime. For project submission the default will be used.
